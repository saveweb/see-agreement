...
If you share a location in a chat, this location data is treated like other messages in [cloud](#331-cloud-chats) or [secret chats](#332-secret-chats) respectively.
...
+ Improved structure, moving 3.3.5 to [3.4](#334-public-chats) and 3.3.6 to [3.6](#36-cookies).

#### October 26, 2021

+ Expanded [5.6. No Ads Based on User Data](#56-no-ads-based-on-user-data) with information about [sponsored messages in public channels](https://t.me/durov/153).
